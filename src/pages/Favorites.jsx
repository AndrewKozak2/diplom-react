...
function Favorites() {
  ...
  const loadFavorites = () => {
    ...
    fetch('http://localhost:3000/api/products')
      ...
      .then((data) => {
        ...
        const normalized = favoriteItems.map(p => ({ ...p, id: p._id || p.id }));
  ...
  useEffect(() => {
    ...
    // ⏱️ оновлення при зміні localStorage
  ...
  return (
    <section className="pt-36 pb-20 px-6 min-h-screen bg-gradient-to-b from-gray-100 to-gray-200">
